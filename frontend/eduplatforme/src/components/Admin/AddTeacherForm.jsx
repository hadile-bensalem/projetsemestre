  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(result.message || 'Erreur lors de la création de l\'enseignant');
      }
    } catch (err) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Ajouter un enseignant</h2>
        <button
          onClick={onCancel}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
              placeholder="Ex: mohamed.gharbi@institut.tn"
            />
          </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
          <p className="text-sm text-blue-800">
            <strong>Note :</strong> L'enseignant pourra enseigner aux étudiants de toutes les filières. 
            Les associations filière-enseignant peuvent être gérées ultérieurement.
          </p>
        </div>
